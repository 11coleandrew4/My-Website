  ...
  render() {
    return (
      <div id="projects">
        ...
        <div id="gotta-go-title">
          <h1>GottaGo</h1>
        </div>
        <div id="projects-page">
          <Fade delay={300}>
            <div id="gotta-go-container">
              <GottaGoDemo />
              <div id="gotta-go-logo-container">
                <GottaGoLogo />
                <div id="gotta-go-text">
          ...
          <Fade delay={300}>
            <div id="swoopdeck-outer-container">
              <div id="swoopdeck-title">
                <h1>SwoopDeck</h1>
              </div>
              <div id="swoopdeck-container">
                <div id="swoopdeck-logo-container">
                  <div id="swoopdeck-logo">
                    <SwoopDeckLogo />
                  </div>
                  <div id="swoopdeck-text">
                    ...
                    <p id="gotta-go-paragraph">
                      SwoopDeck is a web application that provides a digital
                      solution for both skydivers and the jump-sites they dive
                      from. Much like accruing drivers-ed hours, skydivers need
                      to keep a log of every dive in order to increase their
                      licensing status, however these logs are still physical.
                      SwoopDeck’s platform digitizes those dive logs, and
                      authenticates logs via data from the jump-site. In
                      addition, Jump-sites can book upcoming flights and track
                      relevant business data from past flights on the platform.
                      -
                      <span id="gottago-link">
                        <Link href="https://testingswoops.herokuapp.com/login">
                          Check out the beta-version by clicking here!
          ...
          {/* <Fade delay={300}>
            <div>
              ...
              <p id="swoopdeck-paragraph">
                SwoopDeck is a web application that provides a digital solution
                for both skydivers and the jump-sites they dive from. Much like
                accruing drivers-ed hours, skydivers need to keep a log of every
                dive in order to increase their licensing status, however these
                logs are still physical. SwoopDeck’s platform digitizes those
                dive logs, and authenticates logs via data from the jump-site.
                In addition, Jump-sites can book upcoming flights and track
                relevant business data from past flights on the platform. -
                <span id="gottago-link">
                  <Link href="https://testingswoops.herokuapp.com/login">
                    Check out the beta-version by clicking here!
