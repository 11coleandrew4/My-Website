              ...
              <div id="swoopdeck-logo-container">
                <div id="swoopdeck-text">
                  <p id="gotta-go-paragraph">
                    ...
                    from. Much like accruing drivers-ed hours, skydivers need to
                    keep a log of every dive in order to increase their
                    licensing status, however these logs are still physical.
                    SwoopDeck’s platform digitizes those dive logs, and
                    authenticates logs via data from the jump-site. In addition,
                    Jump-sites can book upcoming flights and track relevant
                    business data from past flights on the platform. -
                    <span id="gottago-link">
